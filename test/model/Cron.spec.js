...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Cron', function() {
      beforeEach(function() {
        instance = new dcs.Cron();
      });

      it('should create an instance of Cron', function() {
        // TODO: update the code to test Cron
        expect(instance).to.be.a(dcs.Cron);
      });

      it('should have the property execTimes (base name: "exec_times")', function() {
        // TODO: update the code to test the property execTimes
        expect(instance).to.have.property('execTimes');
        // expect(instance.execTimes).to.be(expectedValueLiteral);
      });
