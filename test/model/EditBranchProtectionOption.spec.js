...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EditBranchProtectionOption', function() {
      beforeEach(function() {
        instance = new dcs.EditBranchProtectionOption();
      });

      it('should create an instance of EditBranchProtectionOption', function() {
        // TODO: update the code to test EditBranchProtectionOption
        expect(instance).to.be.a(dcs.EditBranchProtectionOption);
      });
